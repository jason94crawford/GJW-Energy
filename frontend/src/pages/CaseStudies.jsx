...
const STUDIES = [
  ...
  },
  {
    ...
    tech: "On-grid solar · rooftop PV · ±4.94 GWh/yr",
    role: "Turnkey EPC",
  ...
  },
  {
    ...
    tech: "On-grid solar · 3,468 modules",
    role: "Turnkey EPC",
    body: "A 2.05 MWp rooftop system at Kenya's first operational Special Economic Zone — 3,468 Jinko N-type modules and 8 Huawei 200KTL inverters powering a 5,000-acre mixed-use city.",
  ...
  },
  {
    ...
    country: "Kenya",
    tech: "On-grid solar · rooftop PV + genset control",
    role: "Turnkey EPC",
  ...
  },
  {
    ...
    tech: "Off-grid solar PV + BESS · diesel displaced",
    role: "Turnkey EPC",
    body: "An off-grid solar and storage system for a remote luxury safari lodge — silent, diesel-free power delivered under a full-turnkey model, far from the nearest grid.",
  ...
  },
  {
    ...
    capacity: "600 kWp",
    country: "Kenya",
    tech: "Off-grid solar PV + BESS",
    role: "Construction partner",
    body: "An off-grid solar plant for a remote conservancy lodge — delivered as construction partner, building power infrastructure where the grid doesn't reach.",
  ...
  },
  {
    ...
    tech: "On-grid solar · grid-tied PV",
    role: "Turnkey EPC",
  ...
  },
  {
    ...
    tech: "Off-grid solar · critical loads",
    role: "Turnkey EPC",
